...
export default function NotificationContent() {
  ...
  return (
    <div className="bg-black/20 rounded-2xl p-8 space-y-10 shadow-lg">
          ...
          {Object.entries(emailNotif).map(([key, enabled]) => (
            ...
            >
              ...
              <input
                ...
                className="h-5 w-5 text-blue-500 bg-black/30 border-gray-600 rounded"
              />
            </label>
          ))}
        </div>
      ...
      <section className="space-y-3">
        ...
        <div className="flex items-center gap-4">
          <select className="p-3 bg-black/30 rounded-xl border border-gray-700 focus:border-blue-500">
